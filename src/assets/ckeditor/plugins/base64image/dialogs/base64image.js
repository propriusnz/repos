	...
	function imagePreview(src){
		...
		if(src == "base64") {
			...
			if(n && "files" in n && n.files && n.files.length > 0 && n.files[0]) {
				...
				if (n.files[0].size >= 1000000) {
					// image file size too big, handle error and let the user know
					//imgPreview.getElement().setStyle("color:#cceeff");
					imgPreview.getElement().setHtml("<span style='color:red;'>The image must be less than 1Mb.</span>");
